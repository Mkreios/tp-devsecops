...
namespace WebApplicationNavigation.Controllers
{
    public class Etudiants1Controller : Controller
    {
        private readonly ScolariteDbContext _context;

        public Etudiants1Controller(ScolariteDbContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["GroupeId"] = new SelectList(_context.Groupes, "Id", "LibGroupe");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LastName,DateN,GroupeId")] Etudiant etudiant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LastName,DateN,GroupeId")] Etudiant etudiant)
        {
            if (id != etudiant.Id)
            {
                return NotFound();
